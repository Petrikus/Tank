...
public abstract class Display {
    ...
    private static BufferStrategy bufferStrategyS ;
    ...
    public static void create(int width, int height, String title, int _clearColor, int numBuffer) {
        ...
        bufferStrategyS = content.getBufferStrategy();
        created = true;
    }
    ...
    {
        Graphics g = bufferStrategyS.getDrawGraphics();
        g.drawImage(buffer, 0, 0, null);
        bufferStrategyS.show();
    }
